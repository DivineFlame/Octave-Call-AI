...
Octave-Call-AI platform ships with Deepgram, Cartesia, OpenAI and Octave-Call-AI transcribers by default. You can take a look at the providers documentation of which language to select for your language requirements.
