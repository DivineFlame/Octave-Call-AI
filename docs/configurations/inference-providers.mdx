...
description: "Configure the speech-to-speech, Octave-Call-AI-managed, or bring-your-own-key models your Octave-Call-AI agents use."
---
...
To configure models, open **Models** in your Octave-Call-AI dashboard:

- **Hosted:** `https://github.com/DivineFlame/Octave-Call-AI/model-configurations`
...
| **Octave-Call-AI** | Use Octave-Call-AI-managed LLM, voice, and transcriber models behind one Octave-Call-AI Service Key. |
...
<Warning>
An LLM is still required when you use Speech to Speech. The realtime model handles the live voice conversation, but Octave-Call-AI uses the LLM for analysis tasks that happen outside the live audio stream.
</Warning>

## Octave-Call-AI

Use **Octave-Call-AI** when you want Octave-Call-AI to manage the model providers for you. This path uses one Octave-Call-AI Service Key for Octave-Call-AI-managed models instead of separate provider keys for LLM, Voice, and Transcriber.

![Octave-Call-AI model configuration](../images/model-configuration-octave-call-ai.png)

Configure:

| Field | What it controls |
|-------|------------------|
| **Voice** | The Octave-Call-AI-managed voice to use. |
| **Speed** | The voice playback speed. |
| **Language** | The language behavior, including multilingual auto-detect when available. |
| **API Key** | Your Octave-Call-AI Service Key. Create Service Keys from **Developers**. |
