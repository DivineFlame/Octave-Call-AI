---
title: "Prerequisites"
description: "System requirements and setup needed to run Octave-Call-AI AI locally"
---
...
To run Octave-Call-AI AI locally, make sure you have the following installed:
...
Octave-Call-AI images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/DivineFlame` - Recommended for most users
- **Docker Hub**: `divineflame` - Alternative registry
...
REGISTRY=ghcr.io/DivineFlame ./start_docker.sh

# Using Docker Hub
REGISTRY=divineflame ./start_docker.sh
```
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/DivineFlame'
.\start_docker.ps1

# Using Docker Hub
$env:REGISTRY = 'divineflame'
.\start_docker.ps1
```
</CodeGroup>
