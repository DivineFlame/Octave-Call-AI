...
description: "Octave-Call-AI provides UI components to build a voice Agent. The voice agent can be created by going to https://github.com/DivineFlame/Octave-Call-AI/workflow and then Creating a new Agent."
---
