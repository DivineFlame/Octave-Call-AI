...
<Tip>
Self-hosted deployments can use Ollama for Chunked Search. Select the **Ollama** embedding provider, use `http://ollama:11434/v1` as the base URL, `ollama` as the API key, and a 1536-dimensional embedding model such as `rjmalagon/gte-qwen2-1.5b-instruct-embed-f16`.
</Tip>
...
3. Octave-Call-AI **processes** the document based on the selected mode
