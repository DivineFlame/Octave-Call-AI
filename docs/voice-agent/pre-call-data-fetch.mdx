...
| Field | Description |
| --- | --- |
| **Endpoint URL** | The URL Octave-Call-AI will send the POST request to. |
...
Octave-Call-AI sends a `POST` request with the following JSON payload:
...
```javascript
app.post("/octave-call-ai/pre-call", async (req, res) => {
