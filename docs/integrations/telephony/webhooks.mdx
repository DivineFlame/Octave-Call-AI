...
description: "How Octave-Call-AI AI handles telephony webhooks and audio streaming"
---

## Overview

Octave-Call-AI AI uses webhooks to communicate with telephony providers for call events and audio streaming. Webhooks are automatically configured when you initiate calls.
...
Octave-Call-AI AI automatically:
