...
description: "Connect Octave-Call-AI to Tuner — the observability, simulation, and testing layer for voice"
---
...
- A Octave-Call-AI voice agent workflow

## Setup

### 1. Create an agent in Tuner

Log in to [Tuner](https://app.usetuner.ai) and create a new agent. When configuring the agent, set the **Provider** to **Custom API** — this is required for the Octave-Call-AI integration.
...
In your Octave-Call-AI workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Tuner**.

<img
  src="/images/tuner-octave-call-ai-workflow-builder.png"
  alt="Octave-Call-AI voice workflow builder — click Add node"
/>
...
<img
  ...
  alt="Octave-Call-AI Integrations panel showing QA Analysis, Tuner, and Webhook"
/>
...
<img
  ...
  alt="Octave-Call-AI Edit Tuner modal with credential fields and Enabled toggle"
/>
