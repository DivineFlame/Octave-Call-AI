...
class OrganizationUsageClient(BaseDBClient):
    ...
    async def get_current_usage(self, organization_id: int) -> dict:
        ...
        async with self.async_session() as session:
            ...
            result = {
                ...
                "used_octave_call_ai_tokens": cycle.used_octave_call_ai_tokens,
        ...
        async with self.async_session() as session:
            ...
            for run in runs:
                ...
                run_data = {
                    ...
                    "octave_call_ai_token_usage": octave_call_ai_tokens,
    ...
    async def get_daily_usage_breakdown(
        ...
        async with self.async_session() as session:
            ...
            total_minutes = 0
            total_cost_usd = 0
            total_octave_call_ai_tokens = 0

            for row in daily_usage:
                seconds = row.total_seconds or 0
                minutes = seconds / 60
                cost_usd = seconds * price_per_second_usd
                octave_call_ai_tokens = cost_usd * 100  # 1 cent = 1 token

                total_minutes += minutes
                total_cost_usd += cost_usd
                total_octave_call_ai_tokens += octave_call_ai_tokens
                ...
                breakdown.append(
                    {
                        ...
                        "octave_call_ai_tokens": round(octave_call_ai_tokens, 0),
            ...
            return {
                ...
                "total_octave_call_ai_tokens": round(total_octave_call_ai_tokens, 0),
                "currency": "USD",
            }
