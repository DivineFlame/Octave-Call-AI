"""Tests for the Python runtime SDK (`octave_call_ai_sdk`).
...
import pytest
from octave_call_ai_sdk import Workflow
from octave_call_ai_sdk._generated_models import NodeSpec
from octave_call_ai_sdk.errors import ValidationError
...
class _StubClient:
    """Stand-in for OctaveCallAIClient backed by the in-process spec registry.
...
def test_webhook_complex_fields_validate(client: _StubClient):
    ...
    wh = wf.add(
        ...
        custom_headers=[{"key": "X-Source", "value": "octave_call_ai"}],
