...
def _make_service() -> OctaveCallAIGrokRealtimeLLMService:
    service = OctaveCallAIGrokRealtimeLLMService(api_key="test-key")
...
def test_factory_creates_octave_call_ai_grok_realtime_service():
    ...
    assert isinstance(service, OctaveCallAIGrokRealtimeLLMService)
