...
class _TestOctaveCallAIGeminiLiveLLMService(OctaveCallAIGeminiLiveLLMService):
    """Octave-Call-AI Gemini service with client creation stubbed for unit tests."""
...
def _make_service() -> _TestOctaveCallAIGeminiLiveLLMService:
    service = _TestOctaveCallAIGeminiLiveLLMService(api_key="test-key")
