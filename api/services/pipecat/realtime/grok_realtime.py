"""Octave-Call-AI subclass of pipecat's Grok Realtime LLM service.
...
- **finalized=True on TranscriptionFrame** for parity with Octave-Call-AI's other
  realtime providers.
"""
...
class OctaveCallAIGrokRealtimeLLMService(GrokRealtimeLLMService):
    """Grok Realtime with Octave-Call-AI engine integration quirks."""
