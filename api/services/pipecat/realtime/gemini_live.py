"""Octave-Call-AI subclass of pipecat's Gemini Live LLM service.
...
class OctaveCallAIGeminiLiveLLMService(GeminiLiveLLMService):
    """Gemini Live with Octave-Call-AI engine integration quirks. See module docstring."""
    ...
    # ------------------------------------------------------------------
    # Context lifecycle: Octave-Call-AI pre-populates self._context via the engine,
    ...
    # init-instruction reconciliation (Octave-Call-AI updates system_instruction at
    ...
    # kick off bot turns in the Octave-Call-AI flow.
    # ------------------------------------------------------------------
