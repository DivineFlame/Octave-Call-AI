"""Octave-Call-AI subclass of pipecat's OpenAI Realtime LLM service.

Layers Octave-Call-AI engine integration quirks onto upstream-pristine
...
- **One-off LLMMessagesAppendFrame handling** for ephemeral realtime prompts
  like user-idle checks, without mutating Octave-Call-AI's local ``LLMContext``.
...
class OctaveCallAIOpenAIRealtimeLLMService(OpenAIRealtimeLLMService):
    """OpenAI Realtime with Octave-Call-AI engine integration quirks. See module docstring."""

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self._user_is_muted: bool = False
        # Octave-Call-AI pre-populates self._context via the engine before the first
        ...
        # has finished speaking, matching Octave-Call-AI's Gemini Live behavior.
    ...
    async def process_frame(self, frame: Frame, direction: FrameDirection):
        ...
        if isinstance(frame, TTSSpeakFrame):
            ...
            # lifecycle even when Octave-Call-AI has already pre-populated self._context.
