...
from api.constants import DEPLOYMENT_MODE, OCTAVE_CALL_AI_MPS_SECRET_KEY, MPS_API_URL
...
class MPSServiceKeyClient:
    ...
    def _get_headers(
        ...
        if DEPLOYMENT_MODE != "oss":
            if OCTAVE_CALL_AI_MPS_SECRET_KEY:
    ...
    async def report_platform_usage(
        ...
        *,
        ...
        """Report hosted Octave-Call-AI platform usage for a completed workflow run."""
        if DEPLOYMENT_MODE == "oss":
    ...
    def validate_service_key(
        ...
        """
        Synchronously validate a Octave-Call-AI service key by checking usage via MPS.
        ...
        try:
            ...
            logger.warning("Failed to validate Octave-Call-AI service key via MPS")
            return False
