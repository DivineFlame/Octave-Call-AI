...
This module implements the telephony provider abstraction for Octave-Call-AI AI. For user-facing documentation, see the [Mintlify docs](https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/integrations/telephony/overview).
...
See the [Custom Provider Guide](https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/integrations/telephony/custom) in the documentation for detailed implementation instructions.
...
- [User Documentation](https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/integrations/telephony/overview)
- [Twilio Integration](https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/integrations/telephony/twilio)
- [Custom Providers](https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/integrations/telephony/custom)
- [Webhooks Guide](https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/integrations/telephony/webhooks)
