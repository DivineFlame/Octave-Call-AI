"""Opt-in marker for exposing a FastAPI route through the Octave-Call-AI SDK.

The generated SDK client (`sdk/python/src/octave_call_ai_sdk/_generated_client.py`
