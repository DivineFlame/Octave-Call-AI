...
async def authenticate_mcp_request() -> UserModel:
    """Resolve the authenticated Octave-Call-AI user for an MCP tool invocation.
    ...
    and user identifiers. `_OrgRoutingExporter` reads `octave-call-ai.org_id`
    ...
    if span.is_recording():
        ...
        # Intentionally NOT `octave-call-ai.org_id` — that attribute triggers the
