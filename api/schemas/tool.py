"""Pydantic schemas for reusable Octave-Call-AI tools.
...
class PresetToolParameter(BaseModel):
    """A parameter injected by Octave-Call-AI at runtime."""
...
class HttpApiConfig(BaseModel):
    ...
    preset_parameters: Optional[List[PresetToolParameter]] = Field(
        default=None,
        description=(
            "Parameters injected by Octave-Call-AI from fixed values or workflow context "
            "templates."
        ),
    )
