...
OCTAVE_CALL_AI_MPS_SECRET_KEY = os.getenv(
    "OCTAVE_CALL_AI_MPS_SECRET_KEY",
    os.getenv("OCTAVE_CALL_AI_MPS_SECRET_KEY", None),
)
MPS_API_URL = os.getenv("MPS_API_URL", "https://services.octave-call-ai.com")
