"""Octave-Call-AI SDK — typed builder for voice-AI workflows.

Runtime SDK: fetches the spec catalog from the Octave-Call-AI backend at session
...
keyed against the fetched spec catalog.
    ...
    from octave_call_ai_sdk import OctaveCallAIClient, Workflow

    with OctaveCallAIClient(base_url="http://localhost:8000", api_key=...) as client:
...
from .client import OctaveCallAIClient
from .errors import ApiError, OctaveCallAISdkError, SpecMismatchError, ValidationError
