...
export function OctaveCallAICreditsCard() {
  const auth = useAuth();
  ...
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle>Octave-Call-AI Model Credits</CardTitle>
        <CardDescription>
          These track usage of Octave-Call-AI models using Octave-Call-AI Service Keys.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isLoadingCredits ? (
          ...
          <p className="text-muted-foreground">
            No Octave-Call-AI service keys configured. Set up a service key in your model configuration to see usage.
          </p>
        )}
