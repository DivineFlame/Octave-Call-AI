...
export type ClientOptions = {
    baseUrl: 'https://github.com/DivineFlame/Octave-Call-AI' | 'http://localhost:8000' | (string & {});
};
...
export type AriConfigurationRequest = {
     ...
     * Ws Client Name
     *
     * websocket_client.conf connection name for externalMedia (e.g., octave_call_ai_staging)
     */
...
export type ByokPipelineAiModelConfiguration = {
    ...
    embeddings?: ({
        ...
        provider: 'octave_call_ai';
    } & OctaveCallAIEmbeddingsConfiguration) | null;
};
...
export type CurrentUsageResponse = {
    ...
    period_end: string;
    /**
     * Used Octave-Call-AI Tokens
     */
    used_octave_call_ai_tokens: number;
    /**
...
export type DailyUsageBreakdownResponse = {
    ...
    /**
     * Total Octave-Call-AI Tokens
     */
    total_octave_call_ai_tokens: number;
    /**
     * Currency
     */
    currency?: string | null;
...
export type DailyUsageItem = {
    ...
    /**
     * Octave-Call-AI Tokens
     */
    octave_call_ai_tokens: number;
    /**
     * Call Count
     */
    call_count: number;
 ...
 * Octave-Call-AI
 */
export type OctaveCallAIEmbeddingsConfiguration = {
    /**
     * Provider
     */
    provider?: 'octave_call_ai';
     ...
     * Model
     *
     * Octave-Call-AI-managed embedding model.
     */
    model?: string;
};
 ...
 * Octave-Call-AI
 */
export type OctaveCallAILlmService = {
    /**
     * Provider
     */
    provider?: 'octave_call_ai';
     ...
     * Model
     *
     * Octave-Call-AI-hosted model tier.
     */
    model?: string;
};
 ...
 */
export type OctaveCallAIManagedAiModelConfiguration = {
    /**
     * Api Key
     */
    api_key: string;
 ...
 * Octave-Call-AI
 */
export type OctaveCallAISttService = {
    /**
     * Provider
     */
    provider?: 'octave_call_ai';
 ...
 * Octave-Call-AI
 */
export type OctaveCallAITtsService = {
    /**
     * Provider
     */
    provider?: 'octave_call_ai';
...
export type GoogleTtsConfiguration = {
     ...
     * Model
     *
     * Google Cloud low-latency TTS engine. Octave-Call-AI maps this to Pipecat's streaming Google TTS service for Chirp 3 HD and Journey voices.
     */
    model?: string;
    /**
     * Voice
...
export type HttpApiConfig = {
     ...
     * Preset Parameters
     *
     * Parameters injected by Octave-Call-AI from fixed values or workflow context templates.
     */
...
export type OrganizationAiModelConfigurationV2 = {
     ...
     * Mode
     */
    mode: 'octave_call_ai' | 'byok';
    octave_call_ai?: OctaveCallAIManagedAiModelConfiguration | null;
...
export type WorkflowRunUsageResponse = {
    ...
    created_at: string;
    /**
     * Octave-Call-AI Token Usage
     */
    octave_call_ai_token_usage: number;
    /**
...
export type GetVoicesApiV1UserConfigurationsVoicesProviderGetData = {
    ...
    path: {
         ...
         * Provider
         */
        provider: 'elevenlabs' | 'deepgram' | 'sarvam' | 'cartesia' | 'octave_call_ai' | 'rime';
    };
    query?: {
        /**
         * Model
