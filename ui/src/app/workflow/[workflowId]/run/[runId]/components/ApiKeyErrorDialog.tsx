...
const SERVICE_KEYS_DOCS_URL = "https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/configurations/api-keys#service-keys";
                            ...
                            <div className="text-sm space-y-1">
                                ...
                                {isBillingCreditsError && (
                                    <p className="text-muted-foreground">
                                        Purchase credits from Billing to continue using Octave-Call-AI-managed models.
                                    </p>
                                )}
                                {isServiceKeyOrgMismatch && (
                                    <a
