      ...
      <div className="w-full max-w-2xl space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Let AI agents access your Octave-Call-AI workspace and documentation via
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              <a
                href="https://github.com/DivineFlame/Octave-Call-AI/tree/main/docs/configurations/tracing"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-0.5 underline"
              >
