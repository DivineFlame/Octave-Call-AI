...
export async function impersonateAsSuperadmin(params: {
  ...
  // (served from the target sub-domain, e.g. app.octave-call-ai.com). The route will set the
  ...
  // superadmin.octave-call-ai.com we want to switch to app.octave-call-ai.com. For any other domain
