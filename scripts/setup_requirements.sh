...
OCTAVE_CALL_AI_DIR="$(dirname "$SCRIPT_DIR")"

cd "$OCTAVE_CALL_AI_DIR"
...
echo "Installing octave-call-ai API requirements..."
uv pip install -r api/requirements.txt

if [ "$DEV_MODE" -eq 1 ]; then
    echo "Installing octave-call-ai API dev requirements..."
