...
# Configures git remotes (origin = your fork, upstream = DivineFlame/Octave-Call-AI),
...
UPSTREAM_URL="https://github.com/DivineFlame/Octave-Call-AI.git"
...
echo -e "${BLUE}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║              Octave-Call-AI Contributor Bootstrap                    ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
canonical_https="https://github.com/DivineFlame/Octave-Call-AI.git"
canonical_ssh="git@github.com:DivineFlame/Octave-Call-AI.git"
...
if $needs_fork_prompt; then
    echo -e "${YELLOW}Enter your fork URL (e.g. https://github.com/<YOUR_HANDLE>/octave-call-ai.git):${NC}"
    read -r -p "> " FORK_URL
    if [[ -z "$FORK_URL" ]]; then
...
if [[ -z "$existing_upstream" ]]; then
    ...
    echo -e "${YELLOW}Reset upstream to DivineFlame/Octave-Call-AI? [y/N]:${NC}"
