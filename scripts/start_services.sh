...
# Log startup
cd "$BASE_DIR"
echo "Starting Octave-Call-AI Services at $(date) in BASE_DIR: ${BASE_DIR}"
...
NGINX_UPSTREAM_TEMPLATE="$BASE_DIR/nginx/octave_call_ai_upstream.conf.template"
NGINX_UPSTREAM_CONF="/etc/nginx/conf.d/octave_call_ai_upstream.conf"
