# Octave-Call-AI SDK Examples

Runnable examples of the Octave-Call-AI SDK in Python and TypeScript.
...
```bash
pip install octave-call-ai-sdk

export OCTAVE_CALL_AI_API_ENDPOINT=http://localhost:8000
export OCTAVE_CALL_AI_API_TOKEN=sk-...
